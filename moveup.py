...
DELAY = 0.01
turns_up = 3 #each turn should increase rope length by 8cm, depends on cur_location how much of that is "down" vs x-direction
#ABSOLUTE DISTANCE DOWN DOES NOT MATTER IN THIS CODE


for j in range(turns_up): #moves several turns UP
