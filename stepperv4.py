#same as v3 but with updated dimensions and bottom of island being different length than top considered
...
length = 119          #height of roof in centimetres minus extra length on bottom of island
...
island_top = 8          #distance from cable attachment to top horizontal edge of island
island_bot = 16         #cable to bottom horizontal edge
...
ybot = length-island_bot #last y pos, at the bottom
